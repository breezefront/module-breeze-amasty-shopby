...
define([
    ...
    $.widget('mage.amShopbyFilterContainer', {
        component: 'amShopbyFilterContainer', // Breeze fix: added component name
        options: {
            collectFilters: 0
        },
        classes: {
        ...
        _create: function () {
            ...
            $.mage.amShopbyFilterAbstract._proto.prototype.setCollectFilters(self.options.collectFilters); // Breeze fix: .prototype => _proto.prototype
            ...
            $(links).each(function (index, value) {
                ...
                $(value).find('a').on('click', function (event) {
                    ...
                    $.mage.amShopbyFilterAbstract._proto.prototype.renderShowButton(event, this); // Breeze fix: .prototype => _proto.prototype
                    self.apply(filter);
                });
        ...
        apply: function (filter) {
            ...
            try {
                ...
                if ($.mage.amShopbyAjax !== 'undefined') {
                    $.mage.amShopbyFilterAbstract._proto.prototype.prepareTriggerAjax(null, null, true); // Breeze fix: .prototype => _proto.prototype
